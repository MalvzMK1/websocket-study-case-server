export default class UUIDGenerator {
  ...
  public generate(): string {
    ...
    const uuid = this._lut[ d0 & 0xff ] + this._lut[ d0 >> 8 & 0xff ] + this._lut[ d0 >> 16 & 0xff ] + this._lut[ d0 >> 24 & 0xff ] + '-' +
